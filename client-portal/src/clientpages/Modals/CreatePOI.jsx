...
function CreatePOI({ open, onClose, id, GetData }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
           setloading(true);
            ...
            const response = await axios.put(`/api-trkclt/add-geofence/${id}`, { name: name, pointType: type, latitude: location.lat, longitude: location.lng, radius: radius });
    ...
    return (
        ...
        <Modal open={open} onClose={onClose} size={"xl"}>
            <div className="text-gray-900 dark:text-gray-200">
                <h2 className="text-2xl font-bold mb-6 text-center">Create New Point</h2>
